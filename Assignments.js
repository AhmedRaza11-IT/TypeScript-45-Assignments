...
var current_users = ["Ahmed", "Haris", "Hamza", "Zaid", "Raza"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
var new_users = ["Adeel", "Rafay", "Ahmed"];
...
var great_magicians = make_great(magicians.slice()); // Use slice() to copy
...
function create_car(manufacturer, model, optionalDetails) {
    var car = { manufacturer: manufacturer, model: model };
    Object.arguments(car, optionalDetails);
    return car;
}
// Create a car with required information and two other details
var car1 = create_car("Tesla", "Model S", { color: "blue", autopilot: "standard" });
var car2 = create_car("Toyota", "Camry", { year: 2023 }); // Fix: Pass the year as an object property
